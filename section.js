        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:40px;align-items:start">
          <div class="card" style="padding:32px">
            <div style="margin-bottom:20px">
              ...
              <input type="text" id="contact-name" class="translatable-input" data-placeholder-pt="O seu nome..." data-placeholder-en="Your name..." placeholder="${ts('O seu nome...')}" style="width:100%;padding:10px 16px;border-radius:10px;border:1.5px solid var(--border);background:var(--bg);color:var(--text);font-size:0.9rem;outline:none;box-sizing:border-box">
            </div>
            <div style="margin-bottom:20px">
              <label style="font-weight:600;font-size:0.88rem;display:block;margin-bottom:6px" data-pt="Email" data-en="Email">Email</label>
              <input type="email" id="contact-email" class="translatable-input" data-placeholder-pt="O seu email..." data-placeholder-en="Your email..." placeholder="${ts('O seu email...')}" style="width:100%;padding:10px 16px;border-radius:10px;border:1.5px solid var(--border);background:var(--bg);color:var(--text);font-size:0.9rem;outline:none;box-sizing:border-box">
            </div>
            <div style="margin-bottom:20px">
              ...
              <textarea id="contact-msg" rows="4" class="translatable-input" data-placeholder-pt="A sua mensagem..." data-placeholder-en="Your message..." placeholder="${ts('A sua mensagem...')}" style="width:100%;padding:10px 16px;border-radius:10px;border:1.5px solid var(--border);background:var(--bg);color:var(--text);font-size:0.9rem;outline:none;resize:vertical;box-sizing:border-box"></textarea>
            </div>
